...
let g:colors_name = "StarkEx"

hi Cursor ctermfg=NONE ctermbg=231 cterm=NONE guifg=NONE guibg=#f8f8f0 gui=NONE
hi Visual ctermfg=NONE ctermbg=235 cterm=NONE guifg=NONE guibg=#161a1f gui=NONE
...
hi Pmenu ctermfg=NONE ctermbg=234 cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi PmenuSel ctermfg=NONE ctermbg=16 cterm=NONE guifg=NONE guibg=#161a1f gui=NONE
hi IncSearch ctermfg=NONE ctermbg=28 cterm=NONE guifg=NONE guibg=#555353 gui=NONE
hi Search ctermfg=NONE ctermbg=22 cterm=NONE guifg=NONE guibg=#555353 gui=NONE
...
" Diff highlighting
hi DiffAdd cterm=NONE ctermfg=231 ctermbg=64
hi DiffDelete	ctermfg=88 ctermbg=NONE cterm=none
hi DiffText ctermbg=24 cterm=NONE
hi DiffChange ctermbg=23 ctermfg=231

hi Normal ctermfg=253 ctermbg=NONE cterm=NONE guifg=#dedede guibg=#2e2c2b gui=NONE
...
hi Comment ctermfg=59 ctermbg=233 cterm=NONE guifg=#615953 guibg=NONE gui=NONE
hi Conditional ctermfg=148 ctermbg=NONE cterm=NONE guifg=#a3a3a3 guibg=NONE gui=NONE
hi Constant ctermfg=197 ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi Define ctermfg=247 ctermbg=NONE cterm=NONE guifg=#a3a3a3 guibg=NONE gui=NONE
hi ErrorMsg ctermfg=231 ctermbg=44 cterm=NONE guifg=#f8f8f0 guibg=#00a8c6 gui=NONE
...
hi NonText ctermfg=59 ctermbg=NONE cterm=NONE guifg=#3b3a32 guibg=#373534 gui=NONE
...
hi Special ctermfg=189 ctermbg=NONE cterm=NONE guifg=#dedede guibg=NONE gui=NONE
hi SpecialKey ctermfg=59 ctermbg=237 cterm=NONE guifg=#3b3a32 guibg=#403e3d gui=NONE
hi Statement ctermfg=178 ctermbg=NONE cterm=NONE guifg=#a3a3a3 guibg=NONE gui=NONE
...
hi Type ctermfg=172 ctermbg=NONE cterm=NONE guifg=NONE guibg=NONE gui=NONE
hi Underlined ctermfg=NONE ctermbg=NONE cterm=underline guifg=NONE guibg=NONE gui=underline
hi Include ctermfg=238 ctermbg=NONE cterm=NONE
...
hi SyntasticErrorSign cterm=NONE ctermfg=254 ctermbg=52
hi SyntasticWarningSign cterm=NONE ctermfg=254 ctermbg=166
